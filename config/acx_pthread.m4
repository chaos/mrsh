...
# linker flags, and the PTHREAD_CFLAGS output variable to any special C
# compiler flags that are needed. (The user can also force certain
...
# AFC to the autoconf macro repository. We are also grateful for the
