...
/* Note that the keyword LHOST is alphabetic with all characters
 * outside of the range A-F.  So it is impossible for the presentable
 * format of an IPv4 or IPv6 address to have any characters in this
 * string.
 */
